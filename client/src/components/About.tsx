      ...
      <div className="container">
        <div className="about__grid">
          ...
          <Reveal className="about__copy" delay={120}>
            ...
            <p>
              STUDIO SETA — приватная студия маникюра в центре Москвы под
              руководством Екатерины Сета. Мы работаем по записи и строим
              расписание вокруг вас: никаких очередей, никакого «запись к
              12:00, приём в 14:00».
            </p>
            <p>
